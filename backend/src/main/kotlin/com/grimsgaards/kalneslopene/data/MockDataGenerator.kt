...
import com.grimsgaards.kalneslopene.milestone.MilestoneEntity
import com.grimsgaards.kalneslopene.milestone.MilestoneRepository
...
import com.grimsgaards.kalneslopene.newsfeed.model.NewsfeedTagEntity
import com.grimsgaards.kalneslopene.newsfeed.model.NewsfeedTagRepository
...
import com.grimsgaards.kalneslopene.weather.WeatherServiceMock
...
class MockDataGenerator(
    ...
    private val milestoneSeed: List<MilestoneEntity> =
        listOf(
            MilestoneEntity(
                ...
                details =
                    listOf(
                        "Grunnleggere:Paulsrud, Andersen, Storbugt",
                        "Arrangør:Bedriftsidretten",
            ...
            MilestoneEntity(
                ...
                details =
                    listOf(
                        "Lørdagsløp innført:2010",
                        "Nyvinning:Moderne nettside",
                        "Bevart:Opprop av løpstid ved målgang",
                    ),
            ),
            MilestoneEntity(
                year = "2011",
            ...
            MilestoneEntity(
                ...
                details =
                    listOf(
                        "Styrke:Kontinuitet gjennom generasjoner",
                        "Milepæler:Løyperekorder",
                        "Sted:Kalnesskogen",
                    ),
            ),
        )
    ...
    companion object {
        ...
        private const val UPCOMING_RACES = 30
