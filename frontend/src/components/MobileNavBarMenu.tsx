...
export default function MobileNavBarMenu({
    ...
    return (
        <div className="md:hidden" id="mobile-nav">
            ...
            />
            <div
                className="fixed left-0 right-0 top-18.25 z-50 border-b bg-white shadow-md overflow-y-auto max-h-[calc(100vh-73px)]">
                                                ...
                                                <div className="px-3 pb-3">
                                                    <div className="flex flex-col gap-2">
                                                        {getRacesByYear(year).map((race) => (
                                                            <Link key={race.id} to={`${basePath}/${year}/${race.week}`}
                                                                  onClick={closeMobile}
