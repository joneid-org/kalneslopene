/*
 * ARCHIVED — do not use until explicitly re-enabled.
 *
 ...
 *               <TableBody>
 *                 <TableRow>
 *                   <TableCell className="text-sm py-1.5 font-medium w-16">Menn</TableCell>
 *                   <TableCell className="text-sm py-1.5">Daniel Andersen</TableCell>
 *                   <TableCell className="text-right text-sm py-1.5 tabular-nums font-mono">19:02</TableCell>
 *                 </TableRow>
 *                 <TableRow>
 *                   <TableCell className="text-sm py-1.5 font-medium w-16">Kvinner</TableCell>
 *                   <TableCell className="text-sm py-1.5">Elsa Skoglund</TableCell>
 *                   <TableCell className="text-right text-sm py-1.5 tabular-nums font-mono">24:10</TableCell>
 *                 </TableRow>
 *               </TableBody>
 *             </Table>
 *           </CardContent>
