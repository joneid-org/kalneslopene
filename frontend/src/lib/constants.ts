...
export const ADMIN_ACTIONS: AdminAction[] = [
  ...
  { label: "Bilder", icon: ImageIcon, path: "/admin/bilder" },
  { label: "Administrer løpere", icon: UserPlusIcon, path: "/admin/løpere" },
  { label: "Arrangører", icon: UsersIcon, path: "/admin/arrangører" },
  { label: "Nyheter", icon: NewspaperIcon, path: "/admin/nyheter" },
  { label: "Tagger", icon: NewspaperIcon, path: "/admin/tagger" },
  {
